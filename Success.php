		...
		<div id="container">
			<div class="bar" id="nav">
				...
				?>
					...
					<h2>You're not finished just yet!</h2>
					<p>
				Thank you for your payment. Your transaction has been completed, and a receipt for your purchase has been emailed to you. Please continue to the <a href="http://oneshpe.shpe.org/wps/portal/oneshpe">SHPE National Registration</a> and complete that application. No payment is necessary!</p>
