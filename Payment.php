		...
		<div id="container">
			<div class="bar" id="nav">
				<?php
					...
					echo $display;
				?>
			</div><div class="bar" id="content"><div id="middle" style="min-height:450px;">
					<?php	
					...
					<table width="100%">
						...
						<tr width="100%">
							<td width="50%" style="vertical-align:top;">
								...
								<div style="font-size:.8em;">First Name: <?=$_POST['firstName']?><br>
							...
							<td width="50%" style="vertical-align:top;">
								...
								<div style="font-size:.8em;">Street Address: <?=$_POST['address']?><br>
								City: <?=$_POST['city']?><br>
